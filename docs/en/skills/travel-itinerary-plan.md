...
Use Airbnb before hotel search when the user prefers homestays, apartments, villas, kitchens/laundry, family stays, long stays, or local-neighborhood lodging. Otherwise use FlyAI/Feizhu hotel search first and Airbnb as optional cross-check.
...
6. Add concise support notes: flights, hotels/homestays/areas, budget confidence, booking checklist, risks.
